...
client.lavalink = new LavalinkManager({
    ...
    playerOptions: {
        ...
        // If true (default), setSponsorBlock() with defaults is called on node change
        // to ensure SponsorBlock plugin events (ChapterStarted/ChapterLoaded) work on the new node.
        // Set to false if you don't use SponsorBlock events.
