...
- For that Example Bot with REDIS Queue, you need to have a running Redis Server (with password if remotely), but you can test it without Redis by **commenting out** the LavalinkManager Option: `queueStore`
