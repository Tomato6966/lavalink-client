...
/** Source Names provided by jiosaavn plugin */
export type JioSaavnPlugin_SourceNames = 'jiosaavn';
...
export type SourceNames = LavalinkSourceNames | LavalinkPlugin_LavaSrc_SourceNames | JioSaavnPlugin_SourceNames;
