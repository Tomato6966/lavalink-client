...
export type ClientCustomSearchPlatformUtils =
  | "local"
  | "http"
  | "https"
  | "link"
...
export type SponsorBlockSegmentEventType =
  | "SegmentSkipped"
  | "SegmentsLoaded"
  | "ChaptersLoaded"
  | "ChapterStarted";
...
export type LavalinkPlayerVoiceOptions = Omit<
  LavalinkPlayerVoice,
  "connected" | "ping"
>;
